    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('partitionIndex', 'int32', false, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [], [], null),
new ProtocolField('committedOffset', 'int64', false, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [], [], null),
new ProtocolField('committedLeaderEpoch', 'int32', false, [5,6,7], [6,7,8,9,10], [], [], null),
new ProtocolField('metadata', 'string', false, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [0,1,2,3,4,5,6,7], [], null),
new ProtocolField('errorCode', 'int16', false, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [], [], null),
