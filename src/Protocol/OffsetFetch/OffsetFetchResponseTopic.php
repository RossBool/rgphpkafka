    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('name', 'string', false, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [], [], null),
new ProtocolField('partitions', OffsetFetchResponsePartition::class, true, [0,1,2,3,4,5,6,7], [6,7,8,9,10], [], [], null),
