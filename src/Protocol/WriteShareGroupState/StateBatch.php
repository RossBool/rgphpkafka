    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('firstOffset', 'int64', false, [0,1], [0,1], [], [], null),
new ProtocolField('lastOffset', 'int64', false, [0,1], [0,1], [], [], null),
new ProtocolField('deliveryState', 'int8', false, [0,1], [0,1], [], [], null),
new ProtocolField('deliveryCount', 'int16', false, [0,1], [0,1], [], [], null),
