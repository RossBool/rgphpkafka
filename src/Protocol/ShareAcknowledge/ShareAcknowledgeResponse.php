 ...
 * The response topics.
 *
 * @var ShareAcknowledgeTopicResponse[]
 */
protected $responses = [];
...
new ProtocolField('acquisitionLockTimeoutMs', 'int32', false, [2], [0,1,2], [], [], null),
new ProtocolField('responses', ShareAcknowledgeTopicResponse::class, true, [0,1,2], [0,1,2], [], [], null),
...
/**
 * @param ShareAcknowledgeTopicResponse[] $responses
 *
 * @return self
 */
