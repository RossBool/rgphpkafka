...
class ListConfigResourcesResponse extends AbstractResponse
{
    /**
...
new ProtocolField('configResources', ConfigResource::class, true, [0,1], [0,1], [], [], null),
...
/**
 * @param ConfigResource[] $configResources
 *
 * @return self
 */
public function setConfigResources(array $configResources): self
{
