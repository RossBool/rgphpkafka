    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('topics', CreatableTopic::class, true, [0,1,2,3,4,5,6,7], [5,6,7], [], [], null),
new ProtocolField('timeoutMs', 'int32', false, [0,1,2,3,4,5,6,7], [5,6,7], [], [], null),
new ProtocolField('validateOnly', 'bool', false, [1,2,3,4,5,6,7], [5,6,7], [], [], null),
