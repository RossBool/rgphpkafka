    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('throttleTimeMs', 'int32', false, [0,1,2,3,4,5,6], [3,4,5,6], [], [], null),
new ProtocolField('topics', TxnOffsetCommitResponseTopic::class, true, [0,1,2,3,4,5,6], [3,4,5,6], [], [], null),
