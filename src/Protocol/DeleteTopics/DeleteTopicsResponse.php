    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('throttleTimeMs', 'int32', false, [1,2,3,4,5,6], [4,5,6], [], [], null),
new ProtocolField('responses', DeletableTopicResult::class, true, [0,1,2,3,4,5,6], [4,5,6], [], [], null),
