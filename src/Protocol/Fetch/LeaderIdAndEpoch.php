    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('leaderId', 'int32', false, [12,13,14,15,16,17,18], [12,13,14,15,16,17,18], [], [], null),
new ProtocolField('leaderEpoch', 'int32', false, [12,13,14,15,16,17,18], [12,13,14,15,16,17,18], [], [], null),
