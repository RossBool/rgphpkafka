    ...
    public function __construct()
{
    if (!isset(self::$maps[self::class])) {
        self::$maps[self::class] = [
            new ProtocolField('name', 'string', false, [1], [0,1], [], [], null),
new ProtocolField('nodeType', 'int8', false, [1], [0,1], [], [], null),
new ProtocolField('sourceTopics', 'string', true, [1], [0,1], [], [], null),
new ProtocolField('sinkTopic', 'string', false, [1], [0,1], [1], [], null),
new ProtocolField('stores', 'string', true, [1], [0,1], [], [], null),
new ProtocolField('successors', 'string', true, [1], [0,1], [], [], null),
